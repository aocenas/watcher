...
module.exports = exports = function (){
  ...
  // argument.
  // Actual restart of the process is timed so multiple file
  // updates triger just one restart. This also mitigates the problem
  // with node firing change event two times for one file change.
  ...
  return {
    watch : function (options) {
      ...
      // This will start the process for the first time
      restartChildProcess(opts.process, opts.procArgs);
